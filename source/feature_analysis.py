...
class FeatureAnalysis(ProcessData):
    ...
    def _get_test_stats(self):
        ...
        try:
            ...
            self.bad_indices = [i for i, value in enumerate(
                                test_segmented_unclean) if value == ['']]
            ...
            raise IndexError
            logging.error("self.test_tweets might be empty. Is test_set.csv " +
                          "empty?")
